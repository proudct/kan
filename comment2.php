...
if($_GET["Action"] == "Save")
{
	...
	//*** Insert Topic ***//
	$strSQL = "INSERT INTO commenttable2 ";
	$strSQL .="(name,comment) ";
	$strSQL .="VALUES ";
              ...
              <div class="col-md-3 col-sm-4">
                  <div class="single-blog two-column">
                      <div class="post-thumb">
                          <a href="blogdetails.html"><img src="images/re/3.png" class="img-responsive" alt=""></a>
                          <div class="post-overlay">
                              <span class="uppercase"><a href="#">20 <br><small>May</small></a></span>
                          </div>
                      </div>
...
ไปใช้ชีวิต Slow Life ไปใช้ชีวิตแบบไม่มีไฟฟ้ากัน!</p>
  ...
  <div class="container">
   ...
   <form action="comment2.php?Action=Save" method="POST">
   <table>
   ...
   <tr><td colspan="2"><br><input type="submit" name="submit" value="Comment"></td></tr>
     ...
     $getquery=mysql_query("SELECT * FROM commenttable2 ORDER BY id DESC");
