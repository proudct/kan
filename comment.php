...
if($_GET["Action"] == "Save")
{
	...
	//*** Insert Topic ***//
	$strSQL = "INSERT INTO commenttable ";
	$strSQL .="(name,comment) ";
	$strSQL .="VALUES ";
...
<body>
              ...
              <div class="col-md-3 col-sm-4">
                  <div class="single-blog two-column">
                      <div class="post-thumb">
                          <a href="blogdetails.html"><img src="images/re/1.png" class="img-responsive" alt=""></a>
                      ...
                      <div class="post-content overflow">
                          <ul class="nav nav-justified post-nav">
                              <li><a href="สังขละบุรี.html"><i class="fa fa-tag"></i>สังขละบุรี</a></li>
                          </ul>
                          <h2 class="post-title bold"><a href="https://pantip.com/topic/33750051">เพราะใจมันเซ เลยหนีไปสังขละ </a></h2>
                          <!-- <h3 class="post-author"><a href="#">Posted by micron News</a></h3> -->
                         <p>หลายคนชอบพูดว่า " ใจมันเซ ทะเลคือจุดหมาย "  แต่เราไม่ใช่  เลยอยากหนีไปที่ไหนซักที่  ไปแบบอยู่กับตัวเอง ไปทบทวน ไปร้องไห้แล้วลืมเรื่องเห้ๆในชีวิต </p>
  ...
  <div class="container">
   ...
   <form action="comment.php?Action=Save" method="POST">
   <table>
