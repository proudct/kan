...
if($_GET["Action"] == "Save")
{
	...
	//*** Insert Topic ***//
	$strSQL = "INSERT INTO commenttable1 ";
	$strSQL .="(name,comment) ";
	$strSQL .="VALUES ";
...
<body>
              ...
              <div class="col-md-3 col-sm-4">
                  <div class="single-blog two-column">
                      <div class="post-thumb">
                          <a href="blogdetails.html"><img src="images/re/2.png" class="img-responsive" alt=""></a>
  ...
  <div class="container">
   ...
   <form action="comment1.php?Action=Save" method="POST">
   <table>
   ...
   <tr><td colspan="2"><br><input type="submit" name="submit" value="Comment"></td></tr>
     ...
     $getquery=mysql_query("SELECT * FROM commenttable1 ORDER BY id DESC");
